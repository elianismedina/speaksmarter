        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex"
                                v-if="user.permissions.includes('read-roles')">
                ...
                <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }"
                    ...
                    <div class="pt-2 pb-3 space-y-1" v-if="user.permissions.includes('read-categories')">
                        <ResponsiveNavLink :href="route('categories.index')" :active="route().current('categories.*')">
                            Categories
                        </ResponsiveNavLink>
                    </div>
                    <div class="pt-2 pb-3 space-y-1" v-if="user.permissions.includes('read-lessons')">
                        <ResponsiveNavLink :href="route('lessons.index')" :active="route().current('lessons.*')">
                            Lessons
                        </ResponsiveNavLink>
                    </div>
                    <div class="pt-2 pb-3 space-y-1" v-if="user.permissions.includes('read-roles')">
